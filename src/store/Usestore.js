...
const SEED_CLIENTS = [
  ...
  { id: 'c5', name: 'Item7Go Restuarant',   email: 'items7go@res.com',   phone: '+234-81637390', address: '321 Ring Rd, Ibadan, Oyo State',   company: 'Item7Go',         createdAt: '2026-06-05' },
...
const SEED_INVOICES = [
  ...
  { id: 'INV-005', clientId: 'c1', clientName: 'Acme Corp',        issueDate: '2024-12-05', dueDate: '2025-01-05', status: 'paid',     items: [{ desc: 'SEO Audit',        qty: 1,  rate: 1200 }], notes: '', tax: 10 },
  ...
  { id: 'INV-006', clientId: 'c4', clientName: 'Item7Go Resturant',issueDate: '2026-07-10', dueDate: '2026-08-10', status: 'pending',  items: [{ desc: 'Fast Foods',   qty: 60, rate: 90 }],  notes: 'Milestone 1', tax: 0 },
  { id: 'INV-006', clientId: 'c6', clientName: 'Kings Burger',    issueDate: '2026-05-30', dueDate: '2025-06-30', status: 'pending',  items: [{ desc: 'Fast Foods',   qty: 100, rate: 90 }],  notes: 'Milestone 1', tax: 0 },
...
const SEED_PAYMENTS = [
  { id: 'p1', invoiceId: 'INV-001', clientName: 'Acme Corp',        amount: 4730,  method: 'Bank Transfer', date: '2024-11-28', note: 'Full payment' },
  { id: 'p2', invoiceId: 'INV-005', clientName: 'Acme Corp',        amount: 1320,  method: 'Credit Card',   date: '2024-12-20', note: '' },
];
...
export function useStore() {
  ...
  const [settings,  setSettingsRaw]  = useState(() => load('inv_settings',  {
    businessName: 'My Business', businessEmail: 'hello@mybusiness.com',
    businessPhone: '', businessAddress: '',
    currency: 'USD', taxLabel: 'Tax', defaultTax: 0,
    logoUrl: '', primaryColor: '#f59e0b',
    paymentTerms: 'Net 30', invoiceNotes: 'Thank you for your business!',
  }));
  ...
  const stats = {
    ...
    outstanding:    invoices.filter(i => ['pending','overdue'].includes(i.status))
                            .reduce((s, i) => s + calcTotal(i.items, i.tax), 0),
    recentInvoices: [...invoices].sort((a,b) => b.issueDate.localeCompare(a.issueDate)).slice(0,5),
  };
